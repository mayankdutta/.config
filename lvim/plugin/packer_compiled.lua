...
_G.packer_plugins = {
  ...
  ["nvim-autopairs"] = {
    ...
    loaded = true,
    path = "/Users/info/.local/share/lunarvim/site/pack/packer/start/nvim-autopairs",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'numb.nvim', 'lsp_signature.nvim', 'playground', 'gitsigns.nvim', 'Comment.nvim', 'nvim-bqf', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
