...
_G.packer_plugins = {
  ...
  ["Comment.nvim"] = {
    after_files = { "/Users/info/.local/share/lunarvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ["dap-buddy.nvim"] = {
    loaded = true,
    path = "/Users/info/.local/share/lunarvim/site/pack/packer/start/dap-buddy.nvim",
  ...
  ["lua-dev.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/info/.local/share/lunarvim/site/pack/packer/opt/lua-dev.nvim",
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'telescope-project.nvim', 'bufferline.nvim', 'toggleterm.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-bqf', 'lsp_signature.nvim', 'playground', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
