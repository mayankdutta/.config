...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'barbar.nvim', 'nvim-toggleterm.lua', 'galaxyline.nvim', 'dashboard-nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'diffview.nvim', 'gitsigns.nvim', 'nvim-comment', 'nvim-bqf', 'playground'}, { event = "BufRead *" }, _G.packer_plugins)]]
