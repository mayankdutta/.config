...
_G.packer_plugins = {
  ...
  ["focus.nvim"] = {
    ...
    loaded = true,
    path = "/Users/info/.local/share/lunarvim/site/pack/packer/start/focus.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'playground', 'gitsigns.nvim', 'nvim-bqf', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
