(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver", "request-light", "url", "./languageservice/utils/arrUtils", "./languageservice/yamlLanguageService", "vscode-nls", "./languageservice/services/yamlSchemaService", "./requestTypes", "./languageservice/utils/paths", "vscode-uri", "./languageservice/utils/schemaUrls", "./languageservice/services/schemaRequestHandler"], factory);
    }
    ...
    const schemaRequestHandlerWrapper = (connection, uri) => {
        return schemaRequestHandler_1.schemaRequestHandler(connection, uri, workspaceFolders, workspaceRoot, useVSCodeContentRequest);
    };
     ...
     */
    connection.onNotification(requestTypes_1.VSCodeContentRequestRegistration.type, () => {
