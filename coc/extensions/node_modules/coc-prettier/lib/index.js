...
function mergeConfig(hasPrettierConfig, additionalConfig, prettierConfig, vscodeConfig) {
  return hasPrettierConfig ? Object.assign({parser: vscodeConfig.parser}, prettierConfig, additionalConfig) : Object.assign(vscodeConfig, prettierConfig, additionalConfig);
}
async function format(text, {languageId, uri}, customOptions) {
  ...
  if (!dynamicParsers.length) {
    ...
    if (parser === "typescript" && languageId == "typescriptreact" && dynamicParsers.includes("babel-ts")) {
      parser = "babel-ts";
    }
  }
