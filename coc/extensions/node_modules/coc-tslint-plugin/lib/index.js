...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let disposable = coc_nvim_1.workspace.onWillSaveTextDocument(ev => {
            if (!autoFixOnSave)
                return;
            if (!utils_1.isEnabled(ev.document))
                return;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.FixAllProvider = exports.getTsLintFixAllCodeAction = void 0;
const utils_1 = __webpack_require__(3);
...
class FixAllProvider {
    provideCodeActions(document, _range, context, _token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return [Object.assign(Object.assign({}, fixAllAction), { title: 'Fix All TSLint', kind: vscode_languageserver_protocol_1.CodeActionKind.Source })];
        });
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.isEnabledForJavaScriptDocument = exports.isEnabled = exports.isJavaScriptDocument = exports.isTypeScriptDocument = void 0;
const coc_nvim_1 = __webpack_require__(1);
