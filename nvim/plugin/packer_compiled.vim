...
_G.packer_plugins = {
  ...
  ["rust-tools.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/info/.local/share/nvim/site/pack/packer/opt/rust-tools.nvim"
  },
  ["telescope.nvim"] = {
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
