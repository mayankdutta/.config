...
_G.packer_plugins = {
  ...
  ["vim-tailwindcss"] = {
    loaded = true,
    path = "/Users/info/.local/share/nvim/site/pack/packer/start/vim-tailwindcss"
  },
  ["vim-vsnip"] = {
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'friendly-snippets', 'nvim-compe', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
